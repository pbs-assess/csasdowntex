...
(ref:caption) (A -- upper left panel) Catch and Total Allowable Catch, (B -- upper right panel) Spawning Stock Biomass (SSB) in relation to the Limit Reference Point (LRP; X) and (proposed) Upper Stock Reference (USR; X), (C -- bottom left panel) Fishing Mortality (F; X) on the left in relation to the Removal Reference (RR) and Natural Mortality (M), (D- bottom right panel) Recruitment (numbers).
