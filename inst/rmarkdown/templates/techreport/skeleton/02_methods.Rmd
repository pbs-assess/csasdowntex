...
(ref:fig-testfig-en) Test figure with a caption will be numbered automatically.

(ref:fig-testfig-french) French caption would go here once you've had it translated.

(ref:fig-testfig-en-alt) Testing the alternative test

(ref:fig-testfig-fr-alt) Test de l'alternative

```{r fig-testfig, fig.pos="H", fig.cap = ifelse(fr(), "(ref:figf-testfig-fr)", "(ref:fig-testfig-en)")}
plot(cars)
```
