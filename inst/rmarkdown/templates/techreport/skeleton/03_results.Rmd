...
(ref:fig-batman-en) Batman!

(ref:fig-batman-french) Batman! - Homme chauve-souris!

(ref:fig-batman-en-alt) Test alternative text for Batman

(ref:fig-batman-fr-alt) Tester le texte alternatif pour Batman

```{r fig-batman, fig.cap=ifelse(fr(), "(ref:fig-batman-fr)", "(ref:fig-batman-en)")}
#' Call the Batman
#'
