...
When you click the **Knit** button above a document in RStudio (or run `csasdowntex::render()` in the R console within the working directory that has your `index.Rmd` file) output will be generated that includes both content as well as the output of any embedded **R** code chunks within the document. You can embed an **R** code chunk like this (`cars` is a built-in **R** dataset):
...
Within CSAS you should use the function `csasdowntex::csas_table()` instead. It just calls the function `kable()`, but it adds some default argument values that will make the tables render correctly in both LaTeX and in Word documents.
