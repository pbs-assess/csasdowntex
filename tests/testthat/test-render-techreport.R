...
expect_message(check_yaml(type = "techreport", verbose = TRUE),
               "contains all necessary YAML options")

# ----------------------------------------------------
# Render the PDF techreport
test_that("render generates the PDF of the techreport", {
...
test_that("render generates the .docx of the techreport", {
  set_french(val = FALSE)
...
test_that("render generates the PDF of the techreport in French", {
  set_french(val = TRUE)
  set_render_type(doc_type = "pdf")
  suppressWarnings(
    render(suppress_warnings = TRUE)
...
# test_that("render generates monochrome code PDF of the techreport",
#  {
#   set_french(val = FALSE)
#   set_render_type(doc_type = "pdf")
